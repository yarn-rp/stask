...
Follow the `stask-coding` skill for the invocation recipe. This is a free-form exploration (no task/spec/subtask), so use Section A of that skill with this prompt:
