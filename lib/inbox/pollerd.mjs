...
import { fetchJiraEvents, addFingerprints as addJiraFingerprints } from './sources/jira.mjs';
    ...
    try {
      ...
      switch (sub.source_type) {
        ...
        case 'linear':
          ...
          break;
        case 'jira':
          ({ events: rawEvents, cursor } = fetchJiraEvents(sub));
          rawEvents = addJiraFingerprints(rawEvents);
          break;
        default:
