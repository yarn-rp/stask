# HEARTBEAT.md — {{FRONTEND_NAME}} (Worker, lead-driven)

**You do not self-poll.** There is no cron tick that invokes you.

The lead supervisor ({{LEAD_NAME}}) summons you via OpenClaw `sessions_spawn` when a task needs frontend work. You receive an ordered batch of subtasks, decide your own bundling, and route all coding through Codex via acpx per `BODY.md`.
