...
OpenCode is available as an alternative coding tool using your model (`{{FRONTEND_MODEL}}`).
...
- Skills live in your workspace at `{{OPENCLAW_HOME}}/workspace-{{PROJECT_SLUG}}/{{FRONTEND_NAME_LOWER}}/skills/` — no syncing needed
